...
const dynCreated = ['slotPickGrid', 'slotUrl', 'slotUrlOk', 'slotUpBtn', 'slotUp', 'slotRemove', 'slotUnfill', 'edName', 'edTags', 'edSave', 'edDel', 'imCopyUrl', 'imOpen', 'assetPickGrid', 'netSearchInput', 'netSearchGrid', 'netSearchBtn'];
